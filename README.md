...
* **Windows:** [Download `turbo-tosec_v2.1.0_Windows.exe`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
* **Linux:** [Download `turbo-tosec_v2.1.0_Linux.tar.gz`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
