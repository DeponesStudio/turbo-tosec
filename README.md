...
* **Windows:** [Download `turbo-tosec_v2.1.2_Windows.exe`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
* **Linux:** [Download `turbo-tosec_v2.1.2_Linux.tar.gz`](https://github.com/deponeslabs/turbo-tosec/releases/latest)
