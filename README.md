...
* **Windows:** [Download `turbo-tosec_v1.7.1_Windows.exe`](https://github.com/berkacunas/turbo-tosec/releases/latest)
* **Linux:** [Download `turbo-tosec_v1.7.1_Linux.tar.gz`](https://github.com/berkacunas/turbo-tosec/releases/latest)
